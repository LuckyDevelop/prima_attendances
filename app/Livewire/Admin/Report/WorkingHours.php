...
class WorkingHours extends AdminComponent
{
    #[Url]
    ...
    {
        $this->reset(['departmentId', 'search']);
        $this->dateFrom = today()->startOfMonth()->toDateString();
        $this->dateTo   = today()->toDateString();
    }
    ...
    {
        return $this->attendanceRepo->getWorkingHoursReport(
    ...
    {
        return view('livewire.admin.report.working-hours', [
            'rows'        => $this->getReport(),
